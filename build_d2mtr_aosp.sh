...
export PACKAGEDIR=$PARENT_DIR/Packages/AOSP_JB_MTR
#Enable FIPS mode
export USE_SEC_FIPS_MODE=true
export ARCH=arm
# export CROSS_COMPILE=$PARENT_DIR/linaro4.5/bin/arm-eabi-
# export CROSS_COMPILE=/home/chiwen/kernel/siyah/arm-2011.03/bin/arm-none-eabi-
# export CROSS_COMPILE=/home/chiwen/android/system/prebuilt/linux-x86/toolchain/arm-eabi-4.4.3/bin/arm-eabi-
# export CROSS_COMPILE=/home/chiwen/androidjb/system/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/arm-eabi-
export CROSS_COMPILE=/home/chiwen/Linaro4.7/android-toolchain-eabi/bin/arm-eabi-
...
cp /home/chiwen/included/com.ktoonsez.KTweaker.apk $PACKAGEDIR/system/app/com.ktoonsez.KTweaker.apk
...
if [ -e $KERNELDIR/arch/arm/boot/zImage ]; then
	...
	rm ramdisk.gz
	rm zImage
	rm ../KT747-Kernel-AOSP-JB-MTR*.zip
	zip -r ../KT747-Kernel-AOSP-JB-MTR-$curdate.zip .
	cd $KERNELDIR
else
